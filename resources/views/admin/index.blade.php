            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
						...
						<li class="submenu">
							<a href="#"><span class="menu-side"><img src="preclinic/assets/img/icons/menu-icon-08.svg" alt=""></span> <span> Staff </span> <span class="menu-arrow"></span></a>
							<ul style="display: none;">
						...
						<li class="submenu">
							<a href="#"><span class="menu-side"><img src="preclinic/assets/img/icons/menu-icon-06.svg" alt=""></span> <span> Departments </span> <span class="menu-arrow"></span></a>
							<ul style="display: none;">
						...
						<li>
							<a href="chat.html"><span class="menu-side"><img src="preclinic/assets/img/icons/menu-icon-10.svg" alt=""></span> <span>Chat</span></a>
						</li>
                        <li class="submenu">
                        ...
                        <li class="submenu">
                            <a href="#"><span class="menu-side"><img src="preclinic/assets/img/icons/menu-icon-13.svg" alt=""></span> <span> Blog</span> <span class="menu-arrow"></span></a>
                            <ul style="display: none;">
						...
						<li>
							<a href="preclinic/assets.html"><i class="fa fa-cube"></i> <span>assets</span></a>
						</li>
						<li>
