        ...
        <div class="card p-4">
            ...
            <form action="{{ route('doctor.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="address" placeholder="enter doctor address"
                        name="address">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="phone" placeholder="enter doctor phone"
                        name="phone">
                </div>
                <div class="form-group">
