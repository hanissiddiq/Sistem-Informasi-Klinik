        ...
        <div class="card p-4">
            ...
            <form action="{{ route('patients.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="address" placeholder="enter patient address"
                        name="address">
                </div>

                <div class="form-group">
                    <label for="birth_date">Birth Date</label>
                    <input type="date" class="form-control" id="birth_date" placeholder="enter patient birth_date"
                        name="birth_date">
                </div>

                <div class="form-group">
                    <label for="national_id">National ID</label>
                    <input type="text" class="form-control" id="national_id" placeholder="enter patient national_id"
                        name="national_id">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="complaint" placeholder="enter patient complaint"
                        name="complaint">
                </div>
                ...
                <div class="form-group">
                    ...
                    <select name="doctor_id" id="doctors" class="form-control" name="doctor_id">
                        ...
                        @foreach ($doctors as $doctor)
                            <option value="{{ $doctor->id }}">dr. {{ $doctor->name }} - {{ $doctor->clinic->name }}
                            </option>
                        @endforeach
                    </select>
                </div>
